...
abstract contract BaseTokenBridge {
    ...
    constructor(address l1GatewayRouter) {
     ...
     */
    function bridgeERC20ToL2(address token, uint256 amount, uint256 gasLimit) internal ValidSender OnlyIfEnoughPay returns(bool, uint256) {
     ...
     * @dev a user needs to pay the gateway router for bridging ERC20 token L1/L2
     */
    function bridgeERC20ToL1(address token, uint256 amount, uint256 gasLimit) internal ValidSender OnlyIfEnoughPay returns(bool, uint256) {
