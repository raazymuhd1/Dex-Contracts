...
contract HelperConfig is Script {
    ...
    function mainnetConfig() public returns(NetworkConfig) {
    ...
    function baseMainnetConfig() public returns(NetworkConfig) {
          NetworkConfig memory network = NetworkConfig({
    ...
    function baseSepoliaConfig() public returns(NetworkConfig) {
          NetworkConfig memory network = NetworkConfig({
